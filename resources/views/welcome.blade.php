  ...
  <main id="main">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5" data-aos="fade-left">
            <h3>Who Are We?</h3>
            <p style="text-align: justify;">The broad mass base is an integrative revolutionary social-political entity; it is based on institutional, normative, national, programmatic, and modernity in discourse, practice, and behavior. It is governed by principles, values and constitution, and a well-established scientific methodology.</p>
            <p><strong>It works on:</strong></p>
            <p style="text-align: justify;">
            Eliminating marginalization, lifting injustice and restoring rights, while ending and combating all manifestations of negative discrimination.</p>

            <p style="text-align: justify;">Participation and work to establish and build the Sudanese state on modernist normative foundations, based on state federation and governance.
            </p>
            <p>Strengthening democracy and democratic action.</p>
    ...
    <section id="faq" class="faq section-bg">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2>Support</h2>
          <p>Support Us Financially and in Kind</p>
        </div>
